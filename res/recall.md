...
- [【关于 召回】 那些你不知道的事](#关于-召回-那些你不知道的事)
  ...
  - [四、用户多兴趣拆分](#四用户多兴趣拆分)
    - [4.1 动机](#41-动机)
    - [4.2 vs 用户行为序列打embedding](#42-vs-用户行为序列打embedding)
    - [4.3 典型工作](#43-典型工作)
  - [五、知识图谱融合召回](#五知识图谱融合召回)
  - [六、图神经网络模型召回](#六图神经网络模型召回)
  - [参考](#参考)
